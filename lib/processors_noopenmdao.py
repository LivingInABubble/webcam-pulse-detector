...
class findFaceGetPulse(object):
    ...
    def run(self, cam):
        ...
        col = (100, 255, 100)
        if self.find_faces:
            cv2.putText(self.frame_out, "Press 'C' to change camera (current: %s)" % str(cam), (10, 25),
        ...
        cv2.putText(self.frame_out, "Press 'Esc' to quit", (10, 100), cv2.FONT_HERSHEY_PLAIN, 1.5, col)
